...
// Define the Cosmos DB customer_container name
param cosmosDbCustomerContainerName string = 'Customer'

// Define the Cosmos DB Product_container name
param cosmosDbProductContainerName string = 'Product'

// Define the Cosmos DB purchases_container name
param cosmosDbCustomerContainerName string = 'Purchases'

// Define the Cosmos DB human_conversations_container name
param cosmosDbHumanConversationsContainerName string = 'Human_Conversations'

// Define the Cosmos DB ai_conversations_container name
param cosmosDbAiConversationsContainerName string = 'AI_Conversations'
...
// Define common tags  
var commonTags = {  
  solution: 'aoai-contact-center-demo'    
}
